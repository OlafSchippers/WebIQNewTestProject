(function () {
    ...
    module.run = function (self) {
        ...
        const controlName = ".my-Popup";                            //verwijzing naar de naam van de popup
        ...
        OnPLCTagChange = im.subscribe([PLC_Tag], (name, value) => { //subscribe in the ItemManager de variabele "PLC_Tag"= OpenPopupBOOL
            ...
            if (value === 1) {                                      //waarde gelijk aan 1
                let popup = shmi.ctrl(controlName);                 //maak variabele popup aan die gekoppeld is aan de ctrl met de popupnaam
                popup.open();                                       //open de popup
            }
            else {
