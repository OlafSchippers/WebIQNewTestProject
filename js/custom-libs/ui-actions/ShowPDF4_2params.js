/**
 * Custom UI-Action 'ShowPDF4_2params'.
 *
 * Description:
...
(function() {
    ...
    /**
     * UI-Action 'ShowPDF4_2params' implementation
     *
     ...
     *
     */
    actions["ShowPDF4_2params"] = function(parameters) {
...
//Place your code here
        ...
        im.readDirect([param0,param1], function(err, result){
        
            if (!err) {
                console.log(result[param0],  result[param1]);

                shmi.notify(result[param0] + result[param1]);
                    let sIframe = "root.content.container.screen.PDF.container.iframe"; //parameters[0];
                    let sSrc= result[param0]+result[param1];
